...
internal static class AgentInterfaceDefinitionFactory
{

    internal static AgentInterfaceDefinition CreateHosted() => new()
    {
        Endpoints = new()
        {
            A2A = true,
    ...
    internal static AgentInterfaceDefinition CreateRemote() => new()
    {
        Endpoints = new()
        {
            A2A = true,
    ...
    internal static EquatableDictionary<string, AgentInterfaceDefinition> CreateCollection() => new()
    {
        { "hosted", CreateHosted() },
        { "remote", CreateRemote() }
    };
